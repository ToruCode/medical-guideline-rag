...
# Re-exports DatasetDocument, DatasetCase, location_key, TEXT_PREVIEW_MAX_CHARS,
# truncate_text, load_dataset, and resolve_report_path from
# scripts.evaluation_common (Issue #10), so every existing
# `from scripts.retrieval_baseline_core import ...` call site keeps working
# unchanged.
__all__ = [
    "TEXT_PREVIEW_MAX_CHARS",
    "Aggregate",
